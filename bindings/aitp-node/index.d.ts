...
export declare class JsInitiatorSession {
   ...
   */
  buildHello(peerManifestJson: string, requestedGrants: Array<string>, oidcMintJwt?: ((arg: string) => string) | undefined | null): string
...
export declare class JsResponderSession {
   ...
   */
  processHello(helloJson: string, oidcMintJwt?: ((arg: string) => string) | undefined | null): JsHelloAckResult
 ...
 */
export declare function verifySessionBundle(bundleEnvelopeJson: string, verifierAid: string, nowUnixSecs?: number | undefined | null, revocationCheck?: ((arg: string) => boolean) | undefined | null): JsBundleOutcome
