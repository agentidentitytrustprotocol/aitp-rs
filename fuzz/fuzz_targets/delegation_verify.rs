...
//! both the single-hop default (`max_delegation_hops = 0`, RFC-AITP-0006) and the
//! multi-hop chain path (`max_delegation_hops > 0`, RFC-AITP-0011: chain assembly,
...
fuzz_target!(|data: &[u8]| {
    ...
    let (max_delegation_hops, token_bytes) = match data.split_first() {
